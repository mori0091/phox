...
#[test]
fn test_none() {
    let (val, sch) = eval_test("None").unwrap();
...
fn test_some_literal() {
    let (val, sch) = eval_test("Some 10").unwrap();
...
#[test]
fn test_cons_nil() {
    let (val, sch) = eval_test("Cons 1 Nil").unwrap();
...
#[test]
fn test_nested_cons() {
    let (val, sch) = eval_test("Cons 1 (Cons 2 Nil)").unwrap();
...
#[test]
fn test_addition() {
    let (val, sch) = eval_test("2 + 3").unwrap();
...
#[test]
fn test_tuple() {
    let (val, sch) = eval_test("(1, Some 2)").unwrap();
...
fn test_singleton_tuple() {
    let (val, sch) = eval_test("(42,)").unwrap();
...
fn test_let_simple() {
    // let x = 10 ; x + 1
    let (val, sch) = eval_test("let x = 10 ; x + 1").unwrap();
...
fn test_let_shadowing() {
    ...
    let (val, sch) = eval_test("let x = 5 ; let x = x + 1 ; x * 2").unwrap();
...
fn test_let_tuple() {
    // let t = (1, Some 2) ; t
    let (val, sch) = eval_test("let t = (1, Some 2) ; t").unwrap();
    assert_eq!(format!("{}", val), "(1, Some 2)");
...
fn test_let_polymorphism_id() {
    ...
    let (val, sch) = eval_test("let id = \\x. x ; (id 1, id true)").unwrap();
...
#[test]
fn test_cmp_eq() {
    let (val, sch) = eval_test("1 == 1").unwrap();
...
#[test]
fn test_cmp_le() {
    let (val, sch) = eval_test("1 <= 0").unwrap();
    assert_eq!(format!("{}", val), "false");
    assert_eq!(format!("{}", sch.pretty()), "Bool");
...
fn test_cmp_gt() {
    ...
    let (val, sch) = eval_test("2 > 1").unwrap();
    assert_eq!(format!("{}", val), "true");
    assert_eq!(format!("{}", sch.pretty()), "Bool");
}
...
#[test]
fn test_cmp_ge() {
    let (val, sch) = eval_test("0 >= 1").unwrap();
    assert_eq!(format!("{}", val), "false");
    assert_eq!(format!("{}", sch.pretty()), "Bool");
...
#[test]
fn test_op_priority() {
    let (val, sch) = eval_test("1 + 2 * 3 == 7").unwrap();
    assert_eq!(format!("{}", val), "true");
    assert_eq!(format!("{}", sch.pretty()), "Bool");
}
...
#[test]
fn test_pat_var() {
    let (val, sch) = eval_test("let x = 42 ; x").unwrap();
    assert_eq!(format!("{}", val), "42");
    assert_eq!(format!("{}", sch.pretty()), "Int");
}
...
fn test_pat_wildcard() {
    let (val, sch) = eval_test("let _ = 42 ; 0").unwrap();
    assert_eq!(format!("{}", val), "0");
    assert_eq!(format!("{}", sch.pretty()), "Int");
}
...
#[test]
fn test_pat_lit() {
    let (val, sch) = eval_test("let 1 = 1 ; 99").unwrap();
    assert_eq!(format!("{}", val), "99");
    assert_eq!(format!("{}", sch.pretty()), "Int");
}
...
fn test_pat_tuple_simple() {
    let (val, sch) = eval_test("let (x, y) = (1, 2) ; x + y").unwrap();
...
fn test_pat_tuple_nested() {
    let (val, sch) = eval_test("let (x, (y, z)) = (1, (2, 3)) ; x + y + z").unwrap();
...
fn test_pat_con_list() {
    let (val, sch) = eval_test("let Cons x xs = Cons 1 (Cons 2 Nil) ; x").unwrap();
    assert_eq!(format!("{}", val), "1");
    assert_eq!(format!("{}", sch.pretty()), "Int");
}
...
fn test_pat_con_list_nested() {
    let (val, sch) = eval_test("let Cons x (Cons y ys) = Cons 1 (Cons 2 Nil) ; x + y").unwrap();
    assert_eq!(format!("{}", val), "3");
    assert_eq!(format!("{}", sch.pretty()), "Int");
}
...
fn test_pat_tuple_mismatch() {
    let _ = eval_test("let (x, y) = (1,) ; x").unwrap();
}

#[test]
#[should_panic]
fn test_pat_con_mismatch() {
    let _ = eval_test("let Cons x xs = Nil ; x").unwrap();
}
